  ...
  return (
    <div className="flex h-full bg-gray-50">
      ...
      <div className="flex-1 flex flex-col min-h-screen w-full">
        ...
        {/* Footer - positioned only in main content area, not overlapping sidebar */}
        <footer className="py-2 px-6 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 shadow-sm relative z-0 mt-auto">
          <div className="flex justify-between items-center">
            <p className="text-xs text-gray-500 dark:text-gray-400">© {new Date().getFullYear()} Akada - All Rights Reserved</p>
            <div className="flex items-center gap-3">
              <span className="text-xs bg-green-100 dark:bg-green-900/20 text-green-600 dark:text-green-400 px-1.5 py-0.5 rounded-full border border-green-200 dark:border-green-800">
      ...
      {/* Floating Chat Button - positioned above reduced footer */}
      <button className="fixed bottom-16 right-6 bg-indigo-600 text-white p-4 rounded-full shadow-lg hover:bg-indigo-700 transition-colors flex items-center gap-2 z-40">
