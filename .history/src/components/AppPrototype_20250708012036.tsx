  ...
  return (
    <div className="flex h-full bg-gray-50">
      ...
      <div className="flex-1 flex flex-col min-h-screen w-full">
        ...
        {/* Footer - with proper dark mode support and correct z-index */}
        <footer className="py-4 px-6 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 shadow-sm relative z-0">
