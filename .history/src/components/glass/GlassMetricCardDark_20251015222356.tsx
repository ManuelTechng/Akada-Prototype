...
export function GlassMetricCardDark({ value, label, accentColor }: GlassMetricCardDarkProps) {
  ...
  return (
  <div className="relative overflow-hidden rounded-[28px] bg-gray-900/45 backdrop-blur-2xl border border-white/10 px-5 py-6 sm:px-6 sm:py-7 shadow-[0_30px_60px_-40px_rgba(14,24,54,0.9)] group hover:translate-y-[-6px] transition-all cursor-pointer min-h-[180px] w-full max-w-[230px] min-w-[210px] flex flex-col justify-between mx-auto">
      {/* Gradient overlay */}
