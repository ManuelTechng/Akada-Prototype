    ...
    try {
      ...
      for (const file of fileArray) {
        ...
        if (!allowedTypes.includes(file.type)) {
          showNotification(`File type not supported for ${file.name}. Please upload PDF, DOC, DOCX, or TXT files.`, 'error');
          continue;
        }
        ...
        try {
          ...
          showNotification(`${file.name} uploaded successfully! AI review in progress...`, 'success');
        } catch (uploadError) {
