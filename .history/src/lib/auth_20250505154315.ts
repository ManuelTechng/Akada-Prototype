...
export const updateUserProfile = async (userId: string, profile: Partial<UserProfile>) => {
  try {
    ...
    if (existingProfile) {
      ...
      // Ensure test_scores and study_preferences are properly formatted as JSON
      const formattedProfile = {
        ...profile,
        test_scores: profile.test_scores ? profile.test_scores : existingProfile.test_scores,
        study_preferences: profile.study_preferences ? profile.study_preferences : existingProfile.study_preferences,
