      ...
      <div
        className={cn(
          ...
          isDarkTheme
            ...
            : 'bg-[radial-gradient(circle_at_30%_20%,rgba(79,70,229,0.15),transparent_60%)]'
        )}
      />
      <div
        className={cn(
          ...
          isDarkTheme
            ...
            : 'bg-[radial-gradient(circle_at_70%_60%,rgba(14,165,233,0.14),transparent_60%)]'
        )}
      />
      ...
      <div className="relative z-10 flex flex-1 flex-col overflow-hidden">
        ...
        <main
          className={cn(
            ...
            isDarkTheme ? 'bg-transparent' : 'bg-white/80 backdrop-blur'
          )}
        >
          <div className="min-h-full w-full px-4 py-6 sm:px-6 lg:px-10">
            {children}
          </div>
        </main>
      </div>
