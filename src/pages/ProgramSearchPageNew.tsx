...
const ProgramSearchPage: React.FC = () => {
  ...
  const DesktopFilters = () => (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6 sticky top-6 z-10">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white rounded-t-2xl max-h-[80vh] overflow-y-auto">
        <div className="p-4">
          ...
          <div className="space-y-4">
            <div>
              ...
              <select
                value={filters.country}
                onChange={(e) => handleFilterChange('country', e.target.value)}
                className="w-full p-3 bg-gray-50 border-0 rounded-xl focus:bg-white focus:ring-2 focus:ring-indigo-500 focus:outline-none"
              >
                <option value="">Any country</option>
                <option value="Nigeria">Nigeria</option>
                <option value="Germany">Germany</option>
            ...
            <div>
              <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl cursor-pointer">
                ...
                />
                <div>
                  <span className="text-sm font-medium text-gray-900">Funding Available</span>
                  <p className="text-xs text-gray-500">Show programs with scholarships or financial aid</p>
                </div>
              </label>
            </div>
          </div>
          ...
          <div className="flex gap-3 mt-6 pt-4 border-t border-gray-100">
            ...
            <button
              onClick={() => setShowMobileFilters(false)}
              className="flex-1 py-3 px-4 bg-indigo-600 text-white rounded-xl font-medium hover:bg-indigo-700"
            >
              Apply Filters
            </button>
          </div>
        ...
        <div className="p-8 pb-6">
          <div className="flex items-start justify-between mb-6">
            <div className="flex-1 min-w-0 pr-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 leading-tight mb-2 group-hover:text-indigo-600 transition-colors">
                {program.name}
              </h3>
              <p className="text-gray-600 font-medium text-lg">{program.university}</p>
              {program.location && (
          ...
          {/* Tuition Highlight */}
          <div className="bg-gradient-to-r from-gray-50 to-gray-100/50 rounded-xl p-4 mb-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-500 mb-1">Annual Tuition</p>
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-gray-900">{program.country}</p>
              </div>
            </div>
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
              <div className="p-2 bg-white rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-gray-900">{program.duration || 'N/A'}</p>
              </div>
            </div>
          </div>
          ...
          {program.specialization && (
            <div className="mb-6">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 text-blue-700 rounded-xl border border-blue-100">
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-wrap gap-2">
                {program.requirements.slice(0, 3).map((req: string, idx: number) => (
                  <span
                    key={idx}
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white border border-gray-200 text-gray-700 rounded-lg text-sm"
                  >
          ...
          {isExpanded && program.website && (
            <div className="pt-6 border-t border-gray-100">
              <h4 className="font-semibold text-gray-900 mb-3">University Information</h4>
        ...
        <div className="px-8 py-6 bg-gray-50 border-t border-gray-100">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <button className="inline-flex items-center gap-2 text-gray-400 hover:text-gray-600 transition-colors text-sm">
      ...
      <div className="hidden lg:block p-6">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
          ...
          <div className="xl:col-span-1">
            ...
            {/* Tools section */}
            <div className="bg-indigo-600 rounded-xl shadow-sm p-6 text-white sticky top-[calc(100vh-200px)] z-10">
