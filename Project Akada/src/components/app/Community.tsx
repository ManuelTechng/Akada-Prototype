...
const Community: React.FC<CommunityProps> = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      {/* Hero Section */}
      <div className="bg-gradient-to-br from-indigo-600 to-purple-700 rounded-2xl p-8 mb-12 text-primary-foreground relative overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-96 bg-card opacity-5 rounded-full -translate-y-1/2 translate-x-1/2"></div>
      ...
      {/* Search and Filters */}
      <div className="bg-card rounded-xl shadow-sm border border-gray-100 p-6 mb-8">
      ...
      <div className="mb-12">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold text-foreground font-heading">Featured Members</h2>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {featuredMembers.map((member, index) => (
            <div key={index} className="bg-card rounded-xl shadow-sm border border-gray-100 p-6">
      ...
      <div className="mb-12">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold text-foreground font-heading">Upcoming Events</h2>
          <button className="text-primary hover:text-primary font-medium flex items-center gap-1">
            View All Events
            <ChevronRight className="h-5 w-5" />
          </button>
      ...
      <div className="mb-12">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold text-foreground font-heading">Popular Discussions</h2>
          <button className="text-primary hover:text-primary font-medium flex items-center gap-1">
              ...
              <div className="flex justify-between items-start">
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    {topic.hot && (
                      <span className="bg-red-100 text-destructive px-2 py-0.5 rounded-full text-xs">
                        Hot
                      </span>
                    )}
                  </div>
      ...
      <div className="bg-gradient-to-br from-gray-50 to-indigo-50 rounded-2xl p-8 mb-12">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-2xl font-bold text-foreground mb-4 font-heading">Community Guidelines</h2>
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            <div className="bg-card rounded-xl p-6 text-left">
              <h3 className="font-medium text-foreground mb-3">Do's</h3>
            ...
            <div className="bg-card rounded-xl p-6 text-left">
              <h3 className="font-medium text-foreground mb-3">Don'ts</h3>
              <ul className="space-y-2 text-muted-foreground">
                <li className="flex items-center gap-2">
      ...
      {/* Get Involved */}
      <div className="bg-card rounded-xl shadow-sm border border-gray-100 p-8 mb-12">
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold text-foreground mb-4 font-heading">Get Involved</h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-primary/10 rounded-xl p-6">
            ...
            <h3 className="font-medium text-foreground mb-2">Discussion Leader</h3>
            <p className="text-muted-foreground text-sm mb-4">
          ...
          <div className="bg-primary/10 rounded-xl p-6">
            ...
            <h3 className="font-medium text-foreground mb-2">Mentor</h3>
            <p className="text-muted-foreground text-sm mb-4">
          ...
          <div className="bg-primary/10 rounded-xl p-6">
            ...
            <h3 className="font-medium text-foreground mb-2">Event Organizer</h3>
            <p className="text-muted-foreground text-sm mb-4">
          ...
          <div className="bg-chart-1/10 rounded-xl p-6">
            ...
            <h3 className="font-medium text-foreground mb-2">Content Creator</h3>
            <p className="text-muted-foreground text-sm mb-4">
              Share your knowledge through guides, tutorials, or blog posts.
            </p>
            <button className="text-chart-1 text-sm font-medium">Learn More →</button>
          </div>
        </div>
      </div>
      ...
      <div className="bg-card rounded-xl shadow-sm border border-gray-100 p-8">
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold text-foreground mb-4 font-heading">Connect With Us</h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <a
            href="#"
            className="flex items-center gap-3 p-4 rounded-xl border border-border hover:border-primary hover:bg-primary/10 transition-colors"
          >
          ...
          <a
            href="#"
            className="flex items-center gap-3 p-4 rounded-xl border border-border hover:border-blue-200 hover:bg-primary/10 transition-colors"
          >
            <Twitter className="h-6 w-6 text-muted-foreground" />
            <div className="text-left">
              <div className="font-medium text-foreground">Twitter</div>
              <div className="text-sm text-muted-foreground">@AkadaHQ</div>
            </div>
          </a>
          <a
            href="#"
          ...
          >
            ...
            <div className="text-left">
              ...
              <div className="text-sm text-muted-foreground">Akada Community</div>
            </div>
          </a>
          <a
            href="#"
            className="flex items-center gap-3 p-4 rounded-xl border border-border hover:border-gray-400 hover:bg-muted transition-colors"
          >
