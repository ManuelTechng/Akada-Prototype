...
import mainLogo from 'figma:asset/430a52e73dc288723ed79d46ec10415bf74e2494.png';
import miniLogo from 'figma:asset/33a5db83050df89685f494eda5d3b2bfe7baef28.png';
...
export function DarkSidebar() {
  ...
  return (
    <div className={`h-screen bg-gray-900/50 backdrop-blur-xl border-r border-white/5 flex flex-col transition-all duration-300 ${isCollapsed ? 'w-20' : 'w-64'}`}>
      {/* Logo & Toggle */}
